...
<body>
    ...
    <div class="output">
        ...
        $student1 = new Student("John",12356);
        $student2 = new Student("Sarah",40056);

        echo "<p>Name: " . $student1->name . "</p>";
        echo "<p>Number: " . $student1->number . "</p>";

        echo "<p>Name: " . $student2->name . "</p>";
        echo "<p>Number: " . $student2->number . "</p>";
        ?>
    </div>
